...
def result_vw_np (image, kernel, IC, OC, array_row, array_col, method) :
...
def tetris_cc(image, kernel, ic, oc, ar, ac, pw_row, pw_col, pw_ic, pw_oc):
  ...
  print("    No. of PW is", No_parallel_window * math.ceil(ic / pw_ic))
  print("-"*30)
  print("    Performing Tetris-SDK in 1 Group")
  print("-"*30)
...
network_configs = {
    'cnn8-3': (18, 3, 32, 32, 512, 512),
    'inception-4e': (14, 5, 32, 128, 512, 512),
    'resnet50-blk1': (56, 3, 64, 256, 512, 512),
    'densenet40-3': (32, 3, 48, 12, 512, 512),
    # Add more network configurations as needed
}

if __name__ == "__main__":
    # Ask for user input
    network_key = input("Enter network configuration key (e.g., cnn8-3, inception-4e, resnet50-blk1, densenet40-3): ")
    group = int(input("Enter the group number:"))

    # Retrieve the configuration
    if network_key in network_configs:
        image, kernel, ic, oc, ar, ac = network_configs[network_key]
        ...
        pw_row, pw_col, pw_ic, pw_oc = result_vw_np(image, kernel, ic, oc, ar, ac, method)
        ...
        print("    RESULTS of COMPUTING CYCLES")
        print("-"*30)
        number = tetris_cc(image, kernel, ic, oc, ar, ac, pw_row, pw_col, pw_ic, pw_oc)
        print("-"*30)
        print("Total CC")
        print(group*number)
        print("="*50)
    else:
        print("Network configuration not found. Please define the configuration in network_configs yourself.")
